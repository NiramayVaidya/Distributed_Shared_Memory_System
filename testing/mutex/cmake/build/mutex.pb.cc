...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mutex_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::mutex::DefReply, defer_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::mutex::PollRequest)},
  { 5, -1, sizeof(::mutex::PollReply)},
  { 11, -1, sizeof(::mutex::RecvReq)},
  { 16, -1, sizeof(::mutex::RecvReply)},
  { 22, -1, sizeof(::mutex::DefRep)},
  { 27, -1, sizeof(::mutex::DefReply)},
};
...
const char descriptor_table_protodef_mutex_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ecvReply\022\r\n\005reply\030\001 \001(\010\"\010\n\006DefRep\"\031\n\010Def"
  "Reply\022\r\n\005defer\030\001 \001(\01026\n\004Poll\022.\n\004poll\022\022.m"
  "utex.PollRequest\032\020.mutex.PollReply\"\0002@\n\013"
  "RecvRequest\0221\n\013recvRequest\022\016.mutex.RecvR"
  "eq\032\020.mutex.RecvReply\"\0002>\n\014SendDefReply\022."
  "\n\nsendDefRep\022\r.mutex.DefRep\032\017.mutex.DefR"
  "eply\"\000b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mutex_2eproto = {
  false, false, 334, descriptor_table_protodef_mutex_2eproto, "mutex.proto", 
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          defer_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* DefReply::_InternalSerialize(
  ...
  if (this->_internal_defer() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(1, this->_internal_defer(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:mutex.DefReply)
  ...
  if (from._internal_defer() != 0) {
    _internal_set_defer(from._internal_defer());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
