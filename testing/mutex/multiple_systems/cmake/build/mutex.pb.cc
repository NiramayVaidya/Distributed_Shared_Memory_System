...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mutex_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mutex::RecvReq, host_),
  PROTOBUF_FIELD_OFFSET(::mutex::RecvReq, nodeid_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::mutex::DefRep, host_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 19, -1, sizeof(::mutex::RecvReply)},
  { 25, -1, sizeof(::mutex::DefRep)},
  { 31, -1, sizeof(::mutex::DefReply)},
};
...
const char descriptor_table_protodef_mutex_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ollReply\022\016\n\006active\030\001 \001(\010\"7\n\007RecvReq\022\016\n\006s"
  "eqNum\030\001 \001(\004\022\014\n\004host\030\002 \001(\t\022\016\n\006nodeId\030\003 \001("
  "\r\"\032\n\tRecvReply\022\r\n\005reply\030\001 \001(\010\"\026\n\006DefRep\022"
  "\014\n\004host\030\001 \001(\t\"\n\n\010DefReply26\n\004Poll\022.\n\004pol"
  "l\022\022.mutex.PollRequest\032\020.mutex.PollReply\""
  "\0002@\n\013RecvRequest\0221\n\013recvRequest\022\016.mutex."
  "RecvReq\032\020.mutex.RecvReply\"\0002>\n\014SendDefRe"
  "ply\022.\n\nsendDefRep\022\r.mutex.DefRep\032\017.mutex"
  ".DefReply\"\000b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mutex_2eproto = {
  false, false, 379, descriptor_table_protodef_mutex_2eproto, "mutex.proto", 
...
RecvReq::RecvReq(const RecvReq& from)
  ...
  ::memcpy(&seqnum_, &from.seqnum_,
    ...
    reinterpret_cast<char*>(&seqnum_)) + sizeof(nodeid_));
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "mutex.RecvReq.host"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // uint32 nodeId = 3;
...
void RecvReq::InternalSwap(RecvReq* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RecvReq, nodeid_)
      + sizeof(RecvReq::nodeid_)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          auto str = _internal_mutable_host();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "mutex.DefRep.host"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
