...
// uint32 port = 3;
inline void RecvReq::clear_port() {
  port_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RecvReq::_internal_port() const {
  return port_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RecvReq::port() const {
  // @@protoc_insertion_point(field_get:mutex.RecvReq.port)
  return _internal_port();
}
inline void RecvReq::_internal_set_port(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  port_ = value;
}
inline void RecvReq::set_port(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_port(value);
  // @@protoc_insertion_point(field_set:mutex.RecvReq.port)
}
...
// uint32 port = 3;
inline void DefRep::clear_port() {
  port_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 DefRep::_internal_port() const {
  return port_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 DefRep::port() const {
  // @@protoc_insertion_point(field_get:mutex.DefRep.port)
  return _internal_port();
}
inline void DefRep::_internal_set_port(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  port_ = value;
}
inline void DefRep::set_port(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_port(value);
  // @@protoc_insertion_point(field_set:mutex.DefRep.port)
}
